...
let songList = ["Jane", "Married in a Year", "The World's Smallest Violin"];
...
let catapultList = [...studentList, ...teacherList];
let choice = catapultList[5];
console.log(catapultList);
